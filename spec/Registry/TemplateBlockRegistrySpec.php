...
final class TemplateBlockRegistrySpec extends ObjectBehavior
{
    ...
    public function it_is_a_template_block_registry(): void
    {
        $this->shouldImplement(TemplateBlockRegistryInterface::class);
    }

    public function it_returns_all_template_blocks(): void
    {
    ...
    public function it_returns_enabled_template_blocks_for_a_given_event(): void
    {
    ...
    public function it_returns_enabled_template_blocks_for_multiple_events(): void
    {
        $this->beConstructedWith([
    ...
    public function it_returns_enabled_template_blocks_sorted_by_priority_for_multiple_events(): void
    {
        $this->beConstructedWith([
            'generic_event' => [
